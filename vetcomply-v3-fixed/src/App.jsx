...
const InfoButton = ({ infoKey, onClick }) => (
  <button onClick={(e) => { e.stopPropagation(); onClick(infoKey); }} className="p-1.5 hover:bg-slate-100 rounded-full transition-colors group" title="More information">
    ...
    <div className={`bg-white rounded-2xl border border-slate-200 p-5 hover:shadow-lg transition-all ${onClick ? 'cursor-pointer' : ''}`} onClick={onClick}>
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          <InfoButton infoKey={data.infoKey} onClick={onInfoClick} />
